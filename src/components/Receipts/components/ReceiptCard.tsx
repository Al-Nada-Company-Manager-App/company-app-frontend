...
const ReceiptCard = ({ receipt, theme, onClick, onEdit, onPreview, onDelete }: ReceiptCardProps) => {
  return (
    <Card
        ...
        <div className="flex gap-4 w-full">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              ...
              >
                #{receipt.rn_number} - {receipt.customer?.c_name || "Unknown Customer"}
              </h4>
            </div>
            ...
            <div className="mt-2 flex flex-col gap-1">
              ...
              >
                <CalendarOutlined /> {convertTimestampToDate(receipt.rn_created_at)}
              </span>
            </div>
              ...
              <div className="mt-4 flex gap-2 justify-end" onClick={(e) => e.stopPropagation()}>
                {onPreview && (
                  <button
                    ...
                    onClick={() => onPreview(receipt.rn_id)}
                  >
                    Preview
                  </button>
                )}
                ...
                {onDelete && (
                  <button
                    ...
                    onClick={() => onDelete(receipt.rn_id)}
                  >
                    Delete
                  </button>
                )}
