...
const UpdatePurchaseModal = ({
  ...
  const handleSubmit = async (values: PurchaseFormValues) => {
    try {
      ...
      // Format data according to Update API specification
      const purchaseData = {
        ...
        >
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col span={12}>
              <Form.Item label="Customs Number" name="pch_customsnum">
                <Input placeholder="Enter customs number" />
              </Form.Item>
            </Col>
          </Row>
          ...
          {selectedProducts.length > 0 && (
            <Card size="small" style={{ marginBottom: 16 }}>
              ...
              <div
                style={{ textAlign: "right", marginTop: 8, fontWeight: "bold" }}
              >
