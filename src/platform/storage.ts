...
export const getSyncBackendUrl = (): string => {
  return currentBackendUrl || import.meta.env.VITE_API_BASE_URL || "http://192.168.1.100:4000";
};
...
export const getBackendUrl = async (): Promise<string> => {
  const defaultUrl = import.meta.env.VITE_API_BASE_URL || "http://192.168.1.100:4000";
